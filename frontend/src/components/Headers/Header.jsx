...
const Header = () => {
  ...
  return (
    <header className={cn('sticky')}>
      ...
      {/* End: .top-bar */}
      <div className="header-main my-2 py-2">
      ...
      {isActiveMenuMobile && (
        <div
          className={cn(
            ...
            isActiveMenuMobile && 'animate__animated animate__fadeIn',
          )}
        >
                  ...
                  >
                    <div className="nav-categories relative">
                      <div
                        ...
                        className="flex items-center gap-1 px-3 py-2 bg-sky-800 cursor-pointer"
                      >
                        <MdOutlineMenu size={24} />
                        <p className="font-bold">Danh mục sản phẩm</p>
                      </div>
                      <div className="hidden lg:block absolute top-full left-0 right-0 w-full mt-1">
                  ...
                  >
                    <li>
                      <NavLink
                        to="/"
                        className={({ isActive }) => `
                    flex items-center gap-1 px-3 py-2 font-bold uppercase
                    ${isActive ? 'border-b-2 border-sky-100 text-blue-50' : ''}
                `}
                      >
                        Trang chủ
                      </NavLink>
                    ...
                    <li>
                      <NavLink
                        ...
                        className={({ isActive }) => `
                    flex items-center gap-1 px-3 py-2 font-bold uppercase hover:border-b-2 hover:border-sky-100
                    ${isActive ? 'border-b-2 border-sky-100 text-blue-50' : ''}
                `}
                      >
                        Combo tiết kiệm
